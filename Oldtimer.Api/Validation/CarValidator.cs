...
namespace Oldtimer.Api.Validation
{
    public class CarValidator : AbstractValidator<Car>
    {
        public CarValidator()
        {
            ...
            RuleFor(car => car.Sammler)
                .NotNull().WithMessage("Owner (Sammler) must be specified.")
                .SetValidator(new SammlerValidator()); // Sammler wird mit eigenem Validator geprüft
        }
